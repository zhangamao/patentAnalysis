...
public class CompetitorApplicantServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			JFreeChart jfreechart = ChartFactory.createBarChart3D("主要申请者分析",
					"申请者", "专利量", dataset, PlotOrientation.VERTICAL, true, true,
					true);
			// 获得图表区域对象
	...
	public static CategoryDataset createDataset() throws SQLException {
		...
		String sql = "SELECT COUNT(id), Applicant FROM ai GROUP BY SUBSTRING(Applicant,1,2) HAVING COUNT(id) > 20";
		...
		for (int i = 0; i < numList.size(); i++) {
			...
			defaultDataset.addValue(numList.get(i), applicantList.get(i), category);
		}
